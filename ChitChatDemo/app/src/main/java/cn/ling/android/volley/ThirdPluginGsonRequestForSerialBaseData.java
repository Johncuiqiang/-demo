...
public class ThirdPluginGsonRequestForSerialBaseData<T extends ThirdPluginBaseDataEntity> extends GsonRequest<T> {


    public ThirdPluginGsonRequestForSerialBaseData(int method, String url,
