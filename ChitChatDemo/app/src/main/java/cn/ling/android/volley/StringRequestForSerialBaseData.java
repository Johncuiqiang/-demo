...
import cn.ling.android.volley.basehelper.StringRequest;

/**
 * Created by David小硕 on 2016/9/29.
 */

public class StringRequestForSerialBaseData<T extends BaseEntity> extends StringRequest<T> {

    public StringRequestForSerialBaseData(int method, String url, Class<T> clazz,
